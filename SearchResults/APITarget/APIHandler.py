...
class APIHandler:
    def __init__(self, api="FloodWarnings", latitude=0, longitude=0, origin="MAN", destination="OPO", date="2021-05-27",
                 num_adults=1):
        self.api_list = {
...
if __name__ == "__main__":
    ...
    parser.add_argument('--date', type=str, default='2021-05-27', help="Select flight date")
